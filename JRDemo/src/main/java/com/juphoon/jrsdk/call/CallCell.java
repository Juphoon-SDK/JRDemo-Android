...
import com.juphoon.jrsdk.MainApplication;
...
public class CallCell {
    ...
    private void setSessState(int sessState, String phone) {
        ...
        switch (mSessState) {
            case MtcConfConstants.EN_MTC_CONF_PARTP_STATE_DIALINGOUT: {
                setStateText(MainApplication.sApp.getString(R.string.connecting), false);
                break;
            }
            case MtcConfConstants.EN_MTC_CONF_PARTP_STATE_ALERTING: {
            ...
            case MtcConfConstants.EN_MTC_CONF_PARTP_STATE_PENDING: {
                setStateText(MainApplication.sApp.getString(R.string.connecting), true);
                break;
            }
            case MtcConfConstants.EN_MTC_CONF_PARTP_STATE_CONNED: {
                if (mBase == 0) {
            ...
            case MtcConfConstants.EN_MTC_CONF_PARTP_STATE_DISCING: {
                setStateText(MainApplication.sApp.getString(R.string.leaved), false);
//                removeDisconnected(phone);
                break;
            }
            case MtcConfConstants.EN_MTC_CONF_PARTP_STATE_DISCED: {
                setStateText(MainApplication.sApp.getString(R.string.leaved), false);
//                removeDisconnected(phone);
                break;
            }
