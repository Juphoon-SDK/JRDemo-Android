package com.juphoon.jrsdk.manager;
...
public class CmccTokenManager {
    ...
    //juphoon域
//    public static final String APP_KEY = "AEF1DBD66ABF72CA";
//    public static final String APP_ID = "00111609";
    ...
    public void getAppToken(String userName, TokenListener tokenListener) {
        if (mAuthnHelper == null) {
            return;
        }
        mAuthnHelper.getAccessToken(APP_ID, APP_KEY, userName, SsoSdkConstants.LOGIN_TYPE_DEFAULT, tokenListener);
    }
