...
public class RealmGroupMember extends RealmObject {
    ...
    public static JRGroupItem.Member realm2Item(RealmGroupMember realmMember) {
        JRGroupItem.Member member = new JRGroupItem.Member();
    ...
    public static RealmGroupMember item2Realm(JRGroupItem.Member member, RealmGroupMember realmMember) {
